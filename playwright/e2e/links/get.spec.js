...
test('deve retornar uma lista de links encurtados', async ({ auth, links }) => {
...
test('deve retornar uma lista vazia quando o usuário não tiver links encurtados', async ({ auth, links }) => {
